...
int main() {
    ...
    std::string textfields_cfg_path = "C:/Users/mateu/Desktop/projekty/tyre-checker/yolo-files/yolov4-tiny-text-fields-1216-192.cfg";
    std::string textfields_weights_path = "C:/Users/mateu/Desktop/projekty/tyre-checker/yolo-files/yolov4-tiny-text-fields-1216-192_10000.weights";
    std::string textfields_names_path = "C:/Users/mateu/Desktop/projekty/tyre-checker/yolo-files/obj_text_fields.names";

    std::string characters_cfg_path = "C:/Users/mateu/Desktop/projekty/tyre-checker/yolo-files/yolov4-tiny-characters-96-64.cfg";
    std::string characters_weights_path = "C:/Users/mateu/Desktop/projekty/tyre-checker/yolo-files/yolov4-tiny-characters-96-64_7000.weights";
    std::string characters_names_path = "C:/Users/mateu/Desktop/projekty/tyre-checker/yolo-files/obj_characters.names";
    ...
    cv::imwrite("C:/Users/mateu/Desktop/projekty/tyre-checker/data/images_out/107_3104_detections.jpg", ret_img);
    tyre_info.printInfo();
